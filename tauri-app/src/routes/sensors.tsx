import { createFileRoute } from '@tantml:tanstack/react-router'
        ...
        <section className="rounded-lg border border-blue-500/50 bg-blue-500/10 p-6">
          ...
          <div className="space-y-2 text-sm">
            ...
            <ul className="list-disc list-inside space-y-1 text-muted-foreground ml-2">
              ...
              <li>
                <strong className="text-yellow-600">⚠ Motion Sensors</strong> - Requires custom plugin for mobile
              </li>
              <li>
                <strong className="text-yellow-600">⚠ Accelerometer</strong> - Android: SensorManager, iOS: CoreMotion
              </li>
              <li>
                <strong className="text-yellow-600">⚠ Gyroscope</strong> - Custom plugin required
              </li>
              <li>
                <strong className="text-yellow-600">⚠ Magnetometer/Compass</strong> - Custom plugin required
              </li>
            </ul>
            <div className="bg-muted rounded-md p-3 font-mono text-xs mt-2">
              <div># For full sensor support, implement native plugins:</div>
              <div>Android: SensorManager (TYPE_ACCELEROMETER, TYPE_GYROSCOPE, TYPE_MAGNETIC_FIELD)</div>
              <div>iOS: CoreMotion (CMMotionManager, CMDeviceMotion)</div>
            </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="text-muted-foreground">
                ...
                <tr className="border-b">
                  <td className="py-2 px-4">Magnetometer</td>
                  <td className="text-center py-2 px-4">❌</td>
                  <td className="text-center py-2 px-4">❌</td>
                  <td className="text-center py-2 px-4">❌</td>
                  <td className="text-center py-2 px-4">🔶**</td>
                ...
                <tr>
                  <td className="py-2 px-4">Compass</td>
                  <td className="text-center py-2 px-4">❌</td>
                  <td className="text-center py-2 px-4">❌</td>
                  <td className="text-center py-2 px-4">❌</td>
                  <td className="text-center py-2 px-4">🔶**</td>
