...
pub fn drag_preview(_theme: &Theme, shadow_blur: f32) -> container::Style {
    container::Style {
...
pub fn method_badge(_theme: &Theme, method: HttpMethod) -> container::Style {
    ...
    container::Style {
        ...
        border: border::rounded(UiScale::RADIUS_SM).color(colors.border).width(1),
        ..container::Style::default()
    }
}
...
pub fn method_pick_list(_theme: &Theme, status: pick_list::Status) -> pick_list::Style {
    ...
    pick_list::Style {
        ...
        border: border::rounded(UiScale::RADIUS_SM).width(1).color(INPUT),
...
pub fn status_badge(_theme: &Theme, status_code: u16) -> container::Style {
    ...
    container::Style {
        ...
        border: border::rounded(UiScale::RADIUS_MD).color(border_color).width(1),
        ..container::Style::default()
    }
}
...
pub fn body_type_button(_theme: &Theme, status: button::Status, active: bool) -> button::Style {
    ...
    button::Style {
        ...
        border: border::rounded(UiScale::RADIUS_SM)
